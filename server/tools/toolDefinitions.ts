...
export const TOOLS: any[] = [
  ...
  },
  {
    ...
    function: {
      ...
      description: 'List clickable/typeable elements on the page (links, buttons, inputs) with CSS selectors you can use with browser_click_selector / browser_type_selector. Prefer this over coordinate clicking when possible -- it is more reliable.',
      parameters: { type: 'object', properties: {} }
    }
  },
  {
  ...
  },
  {
    ...
    function: {
      ...
      description: 'Click at pixel coordinates within the browser page (fallback when no good selector exists; use a screenshot to find coordinates).',
      parameters: { type: 'object', properties: { x: { type: 'number' }, y: { type: 'number' } }, required: ['x', 'y'] }
    }
  },
  {
